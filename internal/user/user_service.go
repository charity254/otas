...
func (s *userService) createAccounts(user *models.User) error {
	...
	// Personal + locked (10): locked account only, next 5 go to main
	...
	// Personal + locked (5): locked account only
